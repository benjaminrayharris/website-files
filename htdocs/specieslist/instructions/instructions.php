    ...
    <div class="main">
        ...
        <div class="container">
            <div class="content">
                ...
                <p class="notes"><a href="/specieslist/instructions/dandi.php">Download and Install</a></p>
                <p class="notes"><a href="/specieslist/instructions/masterlist.php">Initial Masterlist File</a></p>
                <p class="notes"><a href="/specieslist/instructions/shortcut.php">Make a Shortcut Link</a></p>
                <p class="notes"><a href="/specieslist/instructions/macro.php">Using the Excel Macro</a></p>
                <p class="notes"><a href="/specieslist/instructions/firstrun.php">First Time Use</a></p>
                <p class="notes"><a href="/specieslist/instructions/general.php">General Use</a></p>
                <p class="notes"><a href="/specieslist/instructions/update.php">Update Program</a></p>
